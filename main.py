...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.iconphoto(False, tkinter.PhotoImage(
        ...
        self.left_mouse_button_lable = customtkinter.CTkLabel(
            master=self.left_mouse_button_frame,
            text="Mouse Button")
        ...
        self.middle_frame_bottom.place(
            anchor="center",
            x=250,
            y=255,
            width=480,
        ...
        self.right_button_lable = customtkinter.CTkLabel(
            master=self.right_button_frame,
            text="Hotkey")
        ...
        self.right_hotkey_entry = customtkinter.CTkEntry(
            ...
            textvariable=self.right_hotkey)
        ...
        self.right_mouse_button_lable = customtkinter.CTkLabel(
            master=self.right_mouse_button_frame,
            text="Mouse Button")
...
def keyboard_listener(app, clicker):
    with pynput.keyboard.Listener(
            on_press=lambda key: clicker.on_press(key, app)) as keyboard_listener:
